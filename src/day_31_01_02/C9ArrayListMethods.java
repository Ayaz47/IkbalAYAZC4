...
public class C9ArrayListMethods {
    ...
    public static void main(String[] args) {
       ...
       list2.add("B");
        ...
        ///arrays .sort
        //Collectionss is an library whihc is very usefull with arraylist
        //Collection is data structure

        // System.out.println("Before Sorting");
        // System.out.println("list = " + list);
        /*
        Collection vs Collectionss
        -------------------------
        Collection:  is the root interface of the Collectionss Framework Hierarchy

        Collectionss:  is a utility class which has various method which can be used on various
        collection Objects
