package day_23_10_01;

public class C1Revision {
    /*
     Challenge: Represent An SalesPerson

     Create an SalesPerson class
  ...
  Create a Main class for building SalesPerson instances
 • Build two SalesPerson instances
 • Give one SalesPerson a raise
